            ...
            <div className='p-4 flex flex-col flex-grow'>
                ...
                <div className='space-y-4 mt-auto'>
                    ...
                    <button
                        ...
                        className='w-full bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition-all duration-200 font-semibold shadow-sm hover:shadow-md active:transform active:scale-95'
                    >
                        Add to Cart
                    </button>
                </div>
