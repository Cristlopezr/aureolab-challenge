export const initialData = {
    products: [
        {
            title: 'Sony WH-CH510 Wireless Headphones - Black',
            description:
        ...
        {
            title: 'Aukey EP-T21 True Wireless Earbuds - Black',
            description:
        ...
        {
            title: 'Apple MacBook Air M2 - 13.6” - Silver',
            description:
        ...
        {
            title: 'FIFINE K669B USB Condenser Microphone - Black',
            description:
        ...
        {
            title: 'Lenovo IdeaPad 3 Laptop 15.6" - AMD Ryzen 5, 8GB RAM, 256GB SSD',
            description:
        ...
        {
            title: 'Xiaomi Redmi Note 10 Pro - 128GB, 6GB RAM, AMOLED Display',
            description:
